...
프로그램은 3-5억번의 연산내에 답을 내고 종료되어야 한다.
```
> 연산자마다 차이는 발생할 수 있음
```
시간복잡도 N! 일때 
- N = 12이면 470,000,000. 대략 11까지 돌아가겠구나 생각
시간복잡도 N^2 일때
- N = 10000이면 100,000,000. 대략 만까지 돌아가겠구나 생각
시간복잡도 N^3 일때
- N = 500이면 125,000,000. 대략 500전까지 돌아가겠구나 생각
시간복잡도 N^4 일때
- N = 100이면 100,000,000. 대략 100까지 돌아가겠구나 생각
시간복잡도 2^N 일때
- N = 27이면 130,000,000. 대략 27전까지 돌아가겠구나 생각
시간복잡도 N^2logN 일 때
- N = 3000이면 대략 12전까지 돌아가겠구나 생각
시간복잡도 NlogN일 때
- N = 5,000,000이면 110,000,000 대략 500만 전까지 돌아가겠구나 생각
```
* 메모리 제한이 512MB일 경우
```
